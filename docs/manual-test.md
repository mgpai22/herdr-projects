...
Checked on 2026-09-24 in a scratch `hp-dev` session under a throwaway `HOME` (herdr 0.9.1-custom, Linux x64, OMP 18.3.0, `PI_CODING_AGENT_DIR` pointing at a scratch agent dir).
